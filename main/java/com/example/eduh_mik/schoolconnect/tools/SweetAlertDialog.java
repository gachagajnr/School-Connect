package com.example.eduh_mik.schoolconnect.tools;
...
public class SweetAlertDialog extends Dialog implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSuccessTick = (SuccessTickView)mSuccessFrame.findViewById(cn.pedant.SweetAlert.R.id.success_tick);
        ...
        mCustomImage = (ImageView)findViewById(cn.pedant.SweetAlert.R.id.custom_image);
        mWarningFrame = (FrameLayout)findViewById(cn.pedant.SweetAlert.R.id.warning_frame);
    ...
    private void changeAlertType(int alertType, boolean fromCreate) {
        ...
        if (mDialogView != null) {
            ...
            switch (mAlertType) {
                case ERROR_TYPE:
                    mConfirmButton.setBackgroundResource(cn.pedant.SweetAlert.R.color.error_stroke_color);
                    mErrorFrame.setVisibility(View.VISIBLE);
                    break;
                case SUCCESS_TYPE:
                    mConfirmButton.setBackgroundResource(cn.pedant.SweetAlert.R.color.success_stroke_color);
